...
const BASE_USERS = [
  ...
  },
  {
    ...
    password: 'Maria123*',
    role: 'seller',
    cedulaRuc: '0911122233001',
    direccion: 'Av. Amazonas N34-120',
    ciudad: 'Quito',
    cuentaBancaria: 'Banco Pichincha 2200112233',
    cuentaPayphone: 'maria.vendedora@payphone',
    verificado: true,
  },
  {
    firstName: 'Carlos',
    ...
    password: 'Carlos123*',
    role: 'seller',
    cedulaRuc: '0922233344001',
    direccion: 'Cdla. Kennedy Norte Mz. 12',
    ciudad: 'Guayaquil',
    cuentaBancaria: 'Banco Guayaquil 3300221144',
    cuentaPayphone: 'carlos.vendedor@payphone',
    verificado: true,
  },
  {
    firstName: 'Lucia',
    ...
    password: 'Lucia123*',
    role: 'seller',
    cedulaRuc: '0933344455001',
    direccion: 'Calle Larga 7-45',
    ciudad: 'Cuenca',
    cuentaBancaria: 'Banco Austro 4400332255',
    cuentaPayphone: 'lucia.vendedora@payphone',
    verificado: false,
  },
] as const;
...
async function upsertUser(params: (typeof BASE_USERS)[number]) {
  ...
  return prisma.user.upsert({
    ...
    update: {
      ...
      passwordHash,
      role: params.role,
      cedulaRuc: params.cedulaRuc || null,
      direccion: params.direccion || null,
      ciudad: params.ciudad || null,
      cuentaBancaria: params.cuentaBancaria || null,
      cuentaPayphone: params.cuentaPayphone || null,
      verificado: Boolean(params.verificado),
    },
    create: {
      firstName: params.firstName,
      lastName: params.lastName,
